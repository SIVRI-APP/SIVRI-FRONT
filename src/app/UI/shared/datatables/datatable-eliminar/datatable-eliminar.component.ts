...
@Component({
  selector: 'app-datatable-eliminar',
  standalone: true,
  imports: [RouterLink],
  templateUrl: './datatable-eliminar.component.html',
  styleUrl: './datatable-eliminar.component.css'
})
export class DatatableEliminarComponent {
